...
def cifar10_dataloaders(batch_size=128, data_dir = 'datasets/cifar10', worker=4):
    ...
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=worker, pin_memory=True, drop_last=True)
    test_loader = DataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=worker, pin_memory=True, drop_last=True)
