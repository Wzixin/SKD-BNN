...
parser.add_argument('--epochs', default=800, type=int, metavar='N',
                    help='number of total epochs to run (default: 600 or 800')
...
parser.add_argument('--lr', '--learning_rate', default=0.30, type=float,
                    metavar='LR', help='initial learning rate (default: 0.30)')
...
def train(train_loader, model, criterion, optimizer, epoch, SumWriter, args, KD_Label_bank):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        Fmap_loss = Fmap_loss + L1_1_loss + L1_2_loss + L1_3_loss + L1_4_loss + \
